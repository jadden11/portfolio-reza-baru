...
const Header = () => {
  return (
    <div className="relative py-10 overflow-hidden rounded-3xl">
      <div className="absolute inset-0 -z-10 bg-[url('/reza.png')] bg-cover bg-center blur-sm" />
      <div className="container mx-auto px-5 font-[family-name:var(--font-poppins)] relative z-10 ">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-36 items-center">
          ...
          <div className="mr-10 sm:mt-10 fontfamily-name:var(--font-poppins)">
            <h1 className="text-xl font-semibold text-gray-600 dark:text-gray-400 mb-2 sm:text-3xl md:">
              Software Engineer
            </h1>
            <h1 className="text-4xl font-bold text-blue-200 dark:text-blue-200 mb-3 sm:text-5xl">
              Mohammad Reza
            </h1>
            <p className="text-lg text-black dark:text-gray-300 leading-relaxed mb-5 sm:text-2xl">
